...
import 'package:mypetfinderui/category_list.dart';
import 'package:mypetfinderui/data.dart';
import 'package:mypetfinderui/pet_widget.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(padding: EdgeInsets.symmetric(horizontal: 16,vertical: 8),
              child: Text('Lovely Pit Anywhere',
                style: TextStyle(
                  color: Colors.grey[800],
                  fontSize: 24,
                ),
